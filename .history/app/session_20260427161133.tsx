...
export default function SessionScreen() {
  ...
  /* =========================
     🔥 AUTO RETURN AFTER COMPLETE (FIXED)
  ========================= */
...
return;
  ...
  // 🔥 FAILSAFE: DO NOT TRAP USER
  if (index + 1 >= cards.length) {
    console.log("⚠️ Fallback session end (review failed)");

    setCompleted(true);

    // fake unlock so user isn't trapped
    setUnlockData({
      unlockMinutes: 1,
    });

    // give temporary unlock anyway
